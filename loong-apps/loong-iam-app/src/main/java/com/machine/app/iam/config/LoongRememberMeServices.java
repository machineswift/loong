...
public class LoongRememberMeServices extends AbstractRememberMeServices {
    ...
    public LoongRememberMeServices(String key, UserDetailsService userDetailsService,
